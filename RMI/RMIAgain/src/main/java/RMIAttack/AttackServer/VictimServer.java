package RMIAttack.AttackServer;

import RMIDemo.RemoteObj;
...
public class VictimServer {
    public static class RemoteHelloWorld extends UnicastRemoteObject implements RemoteObj {
        ...
        @Override
        public void sayHello(String keywords) throws RemoteException {
            ;
        }
    }
